...
//            System.out.println("{" + escribir_nodo(nodo.hijos[i].getInfo()) + "}");
    ...
    public String escribir_nodo(String info_nodo) {
    ...
    private void vernivel(Nodo nodo, int n) {
        if (nodo != null) {
            if (n == 0) {
                nodos_nivel++;
            }
    ...
    public String[] getInfo_nivel(Nodo nodo, int n) {
        cont = 0;
        info_nodos_nivel(nodo, n);
        return info_nivel;
    }

    private void info_nodos_nivel(Nodo nodo, int n) {
        if (nodo != null) {
            if (n == 0) {
